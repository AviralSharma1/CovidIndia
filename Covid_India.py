...
covid_df = pd.read_csv(r"D:\Notes\Data Analytics\Corona\Covid 2\IndividualDetails.csv", names = column)
...
plt.title("Tracing of Overall Cases" , fontsize = 25)
# plt.show()
...
fig = plt.gcf()
fig.gca().add_artist(centre_circle)
plt.title("Tracing of Feb Cases", fontsize = 25)
# plt.show()
...
fig = plt.gcf()
fig.gca().add_artist(centre_circle)
plt.title("Tracing of March Cases", fontsize = 25)
# plt.show()
...
fig = plt.gcf()
fig.gca().add_artist(centre_circle)
plt.title("Tracing of April Cases", fontsize = 25)
plt.show()
